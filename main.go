...
var events = alLEvents{
	{
		...
		Description: "Come join with us for a chance to learn how golang works",
	},
	{
		ID:          "2",
		Title:       "Introduction to API",
		Description: "Come join with us for a chance to learn how API works",
	},
}
...
func deleteEvent(w http.ResponseWriter, r *http.Request) {
	...
	for i, singleEvent := range events {
		if singleEvent.ID == eventID {
			...
			fmt.Fprintf(w, "The event is ID %v has been deleted successfully", eventID)
		}
	}
}
func main() {
